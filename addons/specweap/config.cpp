...
class CfgPatches {
    class ADDON {
        ...
        requiredAddons[] = { "ghg_gear", "static_f_vietnam_c", "static_f_vietnam_02_c", "RHS_US_A2_AirImport", "functions_f_vietnam", "ace_compat_sog", "armor_f_vietnam", "armor_f_vietnam_02" };
