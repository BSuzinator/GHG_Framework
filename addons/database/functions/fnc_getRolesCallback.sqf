...
GVARMAIN(isAdmin) = [_isAdminR] call FUNCMAIN(toBool);
GVARMAIN(isOfficer)  = [_isOfficerR] call FUNCMAIN(toBool);
GVARMAIN(isJuniorOfficer) = [_isJuniorOfficerR] call FUNCMAIN(toBool);
GVARMAIN(isDegenerate) = [_isDegenerateR] call FUNCMAIN(toBool);
