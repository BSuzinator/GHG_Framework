...
// HiddenSelection numbers
	...
	while {alive _veh} do {
		...
		if ((isEngineOn _veh) && (player IN _veh) && (cameraView == "INTERNAL")) then {
			...
			{
				_pic = "\MeansCars\2011_CVPI\data\radar\green\0.paa";
				if (_x == 48) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\0.paa";
				};
				if (_x == 49) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\1.paa";
				};
				if (_x == 50) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\2.paa";
				};
				if (_x == 51) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\3.paa";
				};
				if (_x == 52) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\4.paa";
				};
				if (_x == 53) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\5.paa";
				};
				if (_x == 54) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\6.paa";
				};
				if (_x == 55) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\7.paa";
				};
				if (_x == 56) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\8.paa";
				};
				if (_x == 57) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\green\9.paa";
				};
			...
			{
				_pic = "\MeansCars\2011_CVPI\data\radar\yellow\0.paa";
				if (_x == 48) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\0.paa";
				};
				if (_x == 49) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\1.paa";
				};
				if (_x == 50) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\2.paa";
				};
				if (_x == 51) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\3.paa";
				};
				if (_x == 52) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\4.paa";
				};
				if (_x == 53) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\5.paa";
				};
				if (_x == 54) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\6.paa";
				};
				if (_x == 55) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\7.paa";
				};
				if (_x == 56) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\8.paa";
				};
				if (_x == 57) then {
					_pic = "\MeansCars\2011_CVPI\data\radar\yellow\9.paa";
				};
			...
			if (_curtargetspeed > Prevspeed) then {
				...
				{
					_pic = "\MeansCars\2011_CVPI\data\radar\pic0.paa";
					if (_x == 48) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic0.paa";
					};
					if (_x == 49) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic1.paa";
					};
					if (_x == 50) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic2.paa";
					};
					if (_x == 51) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic3.paa";
					};
					if (_x == 52) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic4.paa";
					};
					if (_x == 53) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic5.paa";
					};
					if (_x == 54) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic6.paa";
					};
					if (_x == 55) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic7.paa";
					};
					if (_x == 56) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic8.paa";
					};
					if (_x == 57) then {
						_pic = "\MeansCars\2011_CVPI\data\radar\pic9.paa";
					};
