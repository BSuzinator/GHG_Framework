/*
init func to grab list according to camo and store in ghg_factory_infantry_cars variable on factory bunkers

insert children statements would just grab the array of acceptable vehicles from the bunkers, saving performance in the long run.
*/


["Land_Bunker_F","House_F","House","HouseBase","NonStrategic","Building","Static","All"]
