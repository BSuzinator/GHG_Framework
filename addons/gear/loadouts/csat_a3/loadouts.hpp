class csat_a3
{
	...
	class Vehicles {
		...
		car[] = {
			//Prowler Unarmed
			{ "O_LSV_02_unarmed_F", "O_LSV_02_unarmed_F" },
			//Prowler Armed HMG
			{ "O_LSV_02_armed_F", "O_LSV_02_armed_F" }			
		};
		troopTruck[] = {
			//Zamak Uncovered
			{ "O_Truck_02_transport_F", "O_Truck_02_transport_F" },
			//Zamak Covered
			{ "O_Truck_02_covered_F", "O_Truck_02_covered_F" },
			//Typhoon Uncovered
			{ "O_Truck_03_transport_F", "O_Truck_03_transport_F" },
			//Typhoon Covered
		...
		tank[] = {
			...
			//T-14K
			{ "O_MBT_04_command_F", "O_MBT_04_command_F" }
		};
		...
		heli_unarmed[] = {
			...
			//Taru
			{ "O_Heli_Transport_04_covered_F", "O_Heli_Transport_04_covered_F" },
			//Taru
			{ "O_Heli_Transport_04_box_F", "O_Heli_Transport_04_box_F" },
			//Taru
			{ "O_Heli_Transport_04_ammo_F", "O_Heli_Transport_04_ammo_F" },
			//Taru
			{ "O_Heli_Transport_04_fuel_F", "O_Heli_Transport_04_fuel_F" },
			//Taru
			{ "O_Heli_Transport_04_repair_F", "O_Heli_Transport_04_repair_F" },
			//Taru
			{ "O_Heli_Transport_04_medevac_F", "O_Heli_Transport_04_medevac_F" }
		};
		heli_armed[] = {
			//Orca
			{ "O_Heli_Light_02_dynamicLoadout_F", "O_Heli_Light_02_dynamicLoadout_F" },
			//Taru
			{ "O_Heli_Attack_02_dynamicLoadout_F", "O_Heli_Attack_02_dynamicLoadout_F" }
		};
		...
		plane[] = {
			...
			//Shikra Stealth
			{ "O_Plane_Fighter_02_Stealth_F", "O_Plane_Fighter_02_Stealth_F" }
		};
