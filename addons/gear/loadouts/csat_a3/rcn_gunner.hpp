/*======================================
	Loadout for Recon Gunner (csat_a3)
======================================*/
class rcn_gunner : loadout_base
{
    ...
    {
        classname[] = { "srifle_DMR_05_hex_F", "srifle_DMR_05_blk_F" };
		muzzle[] = { "muzzle_snds_93mmg_tan", "muzzle_snds_93mmg" };
		bipod[] = { "bipod_02_F_hex", "bipod_02_F_blk" };
        laser = "ACE_acc_pointer_green";
        ammo = "10Rnd_93x64_DMR_05_Mag";
        
        class Scopes : Scopes
        {
            sniper_optic[] = { "optic_KHS_hex", "optic_KHS_blk" };
        };
    };
