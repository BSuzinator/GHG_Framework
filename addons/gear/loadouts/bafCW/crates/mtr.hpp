class ghg_crate_bafCW_mtr : ghg_crate_base
{
    displayname = "Mortar";
    cargosize = 2;
    ...
    class items : items {
        ...
        UK3CB_BAF_762_20Rnd_T = 24;
		UK3CB_BAF_1Rnd_60mm_Mo_Shells = 10;
		UK3CB_BAF_1Rnd_60mm_Mo_Smoke_White = 5;
		UK3CB_BAF_1Rnd_60mm_Mo_Flare_White = 5;
        rhs_mag_m67 = 3;
        rhs_mag_an_m8hc = 6;
        vn_40mm_m406_he_mag = 8;
