		...
		class ACE_MainActions : ACE_MainActions {
			...
			class GHG_GearUp_PLT {
				...
				class GHG_GearUp_PLT_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""plt_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_PLT_Doctor {
					...
					condition = "true";
					statement = "[_this # 1, ""plt_doctor""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_PLT_FAC {
					...
					condition = "true";
					statement = "[_this # 1, ""plt_fac""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_PLT_Interp {
					...
					condition = "true";
					statement = "[_this # 1, ""plt_interp""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_PLT_Rifle {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_rifleman""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_Squad {
				...
				class GHG_GearUp_Squad_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_Medic {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_medic""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_AR {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_ar""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_AAR {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_aar""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_AT {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_at""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_Marksman {
					...
					condition = "true";
					statement = "[_this # 1, ""squad_marksman""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_Squad_Rifle {
			...
			class GHG_GearUp_EWS {
				...
				class GHG_GearUp_EWS_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""ews_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_EWS_Comms {
					...
					condition = "true";
					statement = "[_this # 1, ""ews_comms""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_EWS_Comp {
					...
					condition = "true";
					statement = "[_this # 1, ""ews_comp""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_MAA {
				...
				class GHG_GearUp_MAA_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""maa_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MAA_gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""maa_gunner""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MAA_Ammo {
					...
					condition = "true";
					statement = "[_this # 1, ""maa_ammo""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_MAT {
				...
				class GHG_GearUp_MAT_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""mat_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MAT_gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""mat_gunner""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MAT_Ammo {
					...
					condition = "true";
					statement = "[_this # 1, ""mat_ammo""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_MMG {
				...
				class GHG_GearUp_MMG_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""mmg_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MMG_gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""mmg_gunner""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MMG_Ammo {
					...
					condition = "true";
					statement = "[_this # 1, ""mmg_ammo""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_MTR {
				...
				class GHG_GearUp_MTR_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""mtr_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MTR_gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""mtr_gunner""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_MTR_Ammo {
					...
					condition = "true";
					statement = "[_this # 1, ""mtr_ammo""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_RCN {
				...
				class GHG_GearUp_RCN_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""rcn_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_RCN_gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""rcn_gunner""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_RCN_Ammo {
					...
					condition = "true";
					statement = "[_this # 1, ""rcn_ammo""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_LOGI {
				...
				class GHG_GearUp_LOGI_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""logi_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_LOGI_Doctor {
					...
					condition = "true";
					statement = "[_this # 1, ""logi_doctor""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				...
				class GHG_GearUp_LOGI_Repair {
					...
					condition = "true";
					statement = "[_this # 1, ""logi_repair""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_DEMO {
				...
				class GHG_GearUp_DEMO_Lead {
					...
					condition = "true";
					statement = "[_this # 1, ""demo_lead""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_DEMO_Explosive {
					...
					condition = "true";
					statement = "[_this # 1, ""demo_explosive""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_DEMO_Defusal {
					...
					condition = "true";
					statement = "[_this # 1, ""demo_defusal""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_DEMO_Saboteur {
					...
					condition = "true";
					statement = "[_this # 1, ""demo_saboteur""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_LYNX {
				...
				class GHG_GearUp_LYNX_CMDR {
					...
					condition = "true";
					statement = "[_this # 1, ""lynx_cmdr""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_LYNX_Gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""lynx_crew""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_LYNX_Driver {
					...
					condition = "true";
					statement = "[_this # 1, ""lynx_driver""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_WOLF {
				...
				class GHG_GearUp_WOLF_CMDR {
					...
					condition = "true";
					statement = "[_this # 1, ""wolf_cmdr""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_WOLF_Gunner {
					...
					condition = "true";
					statement = "[_this # 1, ""wolf_crew""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_WOLF_Driver {
					...
					condition = "true";
					statement = "[_this # 1, ""wolf_driver""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_RAVN {
				...
				class GHG_GearUp_RAVN_Pilot {
					...
					condition = "true";
					statement = "[_this # 1, ""ravn_pilot""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_RAVN_Crew {
					...
					condition = "true";
					statement = "[_this # 1, ""ravn_crew""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_FLCN {
				...
				class GHG_GearUp_FLCN_Pilot {
					...
					condition = "true";
					statement = "[_this # 1, ""flcn_pilot""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_FLCN_Crew {
					...
					condition = "true";
					statement = "[_this # 1, ""flcn_crew""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_RPTR {
				...
				class GHG_GearUp_RPTR_Pilot {
					...
					condition = "true";
					statement = "[_this # 1, ""rptr_pilot""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
			...
			class GHG_GearUp_KNFS {
				...
				class GHG_GearUp_KNFS_Captain {
					...
					condition = "true";
					statement = "[_this # 1, ""knfs_captain""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_KNFS_Helmsman {
					...
					condition = "true";
					statement = "[_this # 1, ""knfs_driver""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
				class GHG_GearUp_KNFS_Crew {
					...
					condition = "true";
					statement = "[_this # 1, ""knfs_crew""] call ghg_gear_fnc_gearUp";
					insertChildren = "";
					icon = "";
					exceptions[] = {"isNotSwimming"};
				};
