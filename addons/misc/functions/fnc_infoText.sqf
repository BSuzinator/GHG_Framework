/*
	...
	Replaced sound and increased time shown.	
	
*/


(["GHG_InfoTextLayer"] call bis_fnc_rscLayer) cutrsc ["rscInfoText","plain"];
...
(["GHG_InfoTextLayer"] call bis_fnc_rscLayer) cuttext ["","plain"];